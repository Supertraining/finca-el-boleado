  ...
  return (
    <>
      <form className='m-5 border shadow p-3 '>
        ...
        <div className='d-flex'>
          {credentials?.emailConf ? (
            <button
              ...
              onClick={(e) => {
                sendOrder(e);
                setDisableCart('disabled');
              }}
              disabled={orderId || sobreVenta}>
              Realizar compra!
            </button>
          ) : (
            ''
          ...
          {sobreVenta ? (
            <>
              <div className='border rounded text-white p-2 bg-danger '>
                La cantidad que deseas comprar de uno o varios de los productos{' '}
                <b>supera el Stock en Deposito</b> por favor elimínalo y selecciona la cantidad
                disponible.
              </div>
            </>
          ) : (
        ...
        <>
          <div className={orderId ? 'border rounded w-100 my-2 p-2 text-center' : ''}>
            {' '}
            {orderId ? (
              <>
                <p>
...
Form.propTypes = {
  ...
  sobreVenta: PropTypes.bool.isRequired
}
export default Form;
